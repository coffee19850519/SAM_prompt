...
if args.dataset == 'CryoPPP':
    ...
    label_list, name_list = get_imagse_and_labels_path(args.data_path,mode='test')

    turkey_valid_dataset = CryopppDataset(args, args.data_path, name_list, label_list, transform=transform_test,
                                          transform_msk=transform_test_seg, mode='test', prompt=args.prompt_approach)
...
if args.mod == 'sam_adpt':
    ...
    # tol, (eiou, edice) = function.Test_sam(args, nice_test_loader, 0, net)
