...
if args.dataset == 'Turkey':
    ...
    nice_valid_loader = DataLoader(turkey_valid_dataset, batch_size=args.b, shuffle=False, num_workers=8, pin_memory=True)
    '''end'''
...
if args.mod == 'sam_adpt':
    net.eval()
    tol, (eiou, edice) = function.validation_sam(args, nice_valid_loader, start_epoch, net)
