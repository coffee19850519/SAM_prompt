...
def parse_args():    
    ...
    parser.add_argument('-prompt_approach', type=str, required=True, help='the prompt approach: random_click, box or '
                                                                          'points_grids')
    ...
    parser.add_argument('-sam_block_freeze',type=int, required=False, nargs='+',
